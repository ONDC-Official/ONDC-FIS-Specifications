...
| pan | MERCHANT_AND_PRDOUCT_DETAILS | Purchase Finance (with & without AA) | string | false | `^[A-Z]{5}[0-9]{4}[A-Z]$` | - |
...
| gstinProfile_1 | BANK_STATEMENT_AND_GST_RETURNS | Working Capital(Credit Line)| file | true | - | - |
...
| pan | PERSONAL_INFORMATION_TERM | BL - Term Loan | string | true | `^[A-Z]{5}[0-9]{4}[A-Z]$` | - |
...
| udyamNumber | PERSONAL_INFORMATION_TERM_GST | BL - Term Loan with GST | string | false | `^[a-zA-Z0-9-]+$` | - |
